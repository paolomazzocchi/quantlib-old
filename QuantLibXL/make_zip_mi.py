...
def makeZipMi():
    ...
    #zfile.write("Docs/QuantLibXL-docs-1.7.0.chm", ROOT_DIR + "Docs/QuantLibXL-docs-1.7.0.chm")
    zfile.write("xll/QuantLibXLDynamic-vc110-mt-1_7_0.xll", ROOT_DIR + "xll/QuantLibXLDynamic-vc110-mt-1_7_0.xll")
    ...
    zfile.write("../ObjectHandler/xll/ObjectHandler-xll-vc110-mt-1_7_0.xll", ROOT_DIR + "xll/ObjectHandler-xll-vc110-mt-1_7_0.xll")
    ...
    for fileName in glob.glob("../XL-Launcher/bin/Addin/session_file.*.xml"):
        ...
        if -1 != baseName.find("-dev") or -1 != baseName.find("-s"): continue
